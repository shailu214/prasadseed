                ...
                <div class="card">
                  <div class="card-header">
                    <h3 class="card-title" style="width:100%;">
                      ...
                      <span class="atd-block"> <i class="fe fe-edit-3"></i> Salary &nbsp;:&nbsp; Rs.<?=$sallary?></span>
                      <span class="atd-block"> <i class="fe fe-layers"></i> Working &nbsp;:&nbsp; <?=$work_day?> d </span>
                        ...
                        <?php for ($i=1; $i<=$days; $i++ ) { ?>
                          ...
                          <td class="
                            ...
                            <div>
                              ...
                              Logout : <?=(strlen($logs[$i]['logout']))? date("h:i a", strtotime($logs[$i]['logout'])) : '';?>
                            <?php endif; ?>
                            </div>
                          </td>
                          <?=($i==$days)? '</tr>' : ''; ?>
  ...
  <script>
    $(document).ready(function(){
      $("#month").change(function(){
        var m = $("#month").val();
        var y = $("#year").val();
        window.location.href="<?=base_url()?>staff/attendance/<?=$id?>/"+m+"/"+y;
      });
