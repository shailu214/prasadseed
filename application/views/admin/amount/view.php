                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
						  ...
						  <td align="left">  <?=$val['credit_amount']; ?>  </td>
						  <td align="left">  <?=$val['deposit_amount']; ?>  </td>
						  <td align="left">  <?=$val['balance_amount']; ?>  </td>
						  <td align="left">  
							<a class="icon" href="<?=base_url()?>amount/view/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              <i class="fe fe-eye"></i>
                            </a>
							<a class="icon" href="<?=base_url()?>amount/deposit/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              Deposit
                            </a>
							<?php if($this->pageParam->role == 1) { ?>
							<a class="icon" href="<?=base_url()?>amount/add/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              <i class="fe fe-edit"></i>
                            </a>
							<a class="icon delete" href="<?=base_url()?>amount/delete/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
