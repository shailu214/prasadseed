              ...
              <a href="javascript:;" class="pull-right print-btn"><i class="fa fa-print"></i> Print</a>
                ...
                <table style="width:100%;">
                  ...
                  <tr>
                    <td colspan="2">
                      <h4><?=$company_name?></h4>
                      <p style="padding:0px;margin:0px;"><i class="fa fa-user"></i> &nbsp;&nbsp; <?=$vendor_name?></P>
                      <p style="padding:0px;margin:0px;"><i class="fa fa-phone"></i> &nbsp; +91 <?=$vmobile?></P>
                      <?php if(strlen($email)) :?>
                      <p style="padding:0px;margin:0px;"><i class="fa fa-envelope"></i> &nbsp; <?=$email?></p>
                      <?php endif; ?>
                    ...
                    <td colspan="3"><br>
                      <table class="item-tbl">
                        <tr>
                          ...
                          <th>Amount</th>
                          <!-- <th>GST</th> -->
                          <th style="text-align:right" width="150">Sub Total &nbsp; </th>
                        </tr>
                        ...
                        <?php endforeach; ?>
                        <tr>
                          <th colspan="4" class="tfoot">Total</th>
                        ...
                        <tr>
                          ...
                          <td ><b>Due :</b></td>
                          <td colspan="2" style="text-align:left">Rs. <?=$due?></td>
                          <!-- <td></td> -->
                        </tr>
                      </table>
                    </td>
                      ...
                      <tr>
                        <td width="50%">
                          ...
                          <select class="form-control" name="data[mode]">
                            ...
                            <option value="4">Wallet App or Online</option>
                          </select>
                        </div>
                        <div class="form-group">
...
$(document).ready(function(){
  $(document).on("click", ".print-btn", function(){
	  ...
	  var NWin =  window.open('<?=base_url()?>purchase/invprint/<?=$id?>','',"height=650,width=650");
	    if (window.focus)
		     {
		       NWin.focus();
		     }
