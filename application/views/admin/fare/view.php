                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
						  ...
						  <td align="left">  
							<a class="icon" href="<?=base_url()?>fare/view/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              <i class="fe fe-eye"></i>
                            </a>
							<?php if($this->pageParam->role == 1) { ?>
							<a class="icon" href="<?=base_url()?>fare/add/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              <i class="fe fe-edit"></i>
                            </a>
							<a class="delete icon" href="<?=base_url()?>fare/delete/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
