              ...
              <div class="col-12">
                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <a href="<?=base_url()?>farmer/add" class="btn btn-primary btn-sm pull-right" style="color:#fff;"><i class="fe fe-plus"></i> Add New</a>
                    </h3>
                  </div>
                    ...
                    <table class="table card-table table-vcenter text-nowrap">
                      ...
                      <tbody>
                        ...
                        <tr>
						  ...
						  <td align="left">  
							<a class="icon" href="<?=base_url()?>farmer/view/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
                              <i class="fe fe-eye"></i>
                            </a>
							<?php if($this->pageParam->role == 1) { ?>
								<a class="icon" href="<?=base_url()?>farmer/add/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
								  <i class="fe fe-edit"></i>
								</a>
								<a class="delete icon" href="<?=base_url()?>farmer/delete/<?=$val['id']?>" data-row-id="<?=$val['id']?>" data-tbl="category">
