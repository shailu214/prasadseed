    ...
    <div class="row row-cards row-deck">
        ...
        <div class="col-12">
		  ...
		  <div class="card">
            <div class="card-header">
              <h3 class="card-title" style="width:100%;">
            <i class="fe fe-user"></i> Lot Details
              </h3>
            </div>
			...
			<div class="table-responsive">
                    <table class="table card-table table-vcenter text-nowrap">
                      <thead>
						<tr><td colspan="9"  style="border-bottom:1px solid #ddd"></td></tr>
                      ...
                      <tbody>
                       <?php foreach($lots as $lotObj) {
                          ...
                          <th>
						  <?php 
								$db->where('id', $lotObj->farmer_lot_id);
								$lotObjobj = $db->get('farmer_lots')->row();
								if($lotObjobj) {
									echo $lotObjobj->lots;
								}
							?>
						  ...
						  <th>
						  <?php 
								$db->where('sell_id', $lotObj->id);
								$db->limit(1);
								$db->order_by('id', 'desc');
								$dueobj = $db->get('sell_deposit')->row();
								if($dueobj) {
